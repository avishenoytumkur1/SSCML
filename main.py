...
window = tk.Tk()
window.title("Smart Security Camera")
...
label_title = tk.Label(frame1, text="Smart Security Camera")
...
btn2 = tk.Button(frame1, text="Secure", height=90, width=180, fg='orange', command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
